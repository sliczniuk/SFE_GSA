...
plot(time, results.second_order(:,4), 'r-o', 'LineWidth', 2, 'MarkerSize', 6, 'DisplayName', 'S2,TP'); hold on;
plot(time, results.second_order(:,7), 'b-s', 'LineWidth', 2, 'MarkerSize', 6, 'DisplayName', 'S2,TF');
...
interaction = results.interaction(:,1);  % Temperature interactions
interaction_P = results.interaction(:,2);  % Pressure interactions
interaction_F = results.interaction(:,3);  % Flow rate interactions
